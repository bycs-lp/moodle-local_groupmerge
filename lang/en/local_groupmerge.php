...
$string['error_circular_mapping'] = 'This link would create a circular dependency (the target group is transitively a source group of one of the selected source groups).';
