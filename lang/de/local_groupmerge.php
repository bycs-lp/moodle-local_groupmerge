...
$string['error_circular_mapping'] = 'Diese Verknüpfung würde eine zirkuläre Abhängigkeit erzeugen (die Zielgruppe ist transitiv eine Quellgruppe einer der ausgewählten Quellgruppen).';
...
$string['mappingtype_help'] = 'Wählen Sie den Verknüpfungstyp. "Vollständig" bedeutet, dass die Zielgruppe exakt die Mitglieder aller Quellgruppen enthält (zusätzliche Mitglieder werden entfernt). "Teilmenge" bedeutet, dass Quellgruppen-Mitglieder zur Zielgruppe hinzugefügt werden, vorhandene zusätzliche Mitglieder aber erhalten bleiben.';
...
$string['notargetgroups'] = 'Es sind keine Gruppen als Zielgruppe verfügbar. Alle Gruppen werden bereits als Zielgruppe verwendet oder oder steht aus anderen Gründen nicht zur Verfügung.';
